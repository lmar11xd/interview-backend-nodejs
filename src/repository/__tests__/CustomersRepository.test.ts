...
describe('CustomersRepositoryImpl', () => {
  ...
  describe('findByFilterLastname', () => {
    it('should return customers from random user', async () => {
      ...
      // Execute
      const response = await repository.findByFilterLastname(
        new Customer({
          lastName: 'G',
        })
      );
  ...
  describe('findByFilterNameLastname', () => {
    it('should return customers from random user', async () => {
      // Prepare
      const repository = new CustomersRepositoryImpl();
      ...
      // Execute
      const response = await repository.findByFilterNameLastname(
        new Customer({
          name: 'B',
          lastName: 'G',
        })
